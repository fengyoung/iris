...
| 层 | 位置 | 当前值 | 含义 |
|------|------|:---:|------|
| **产品版本** | `pyproject.toml` | 3.37.0 | 软件发布版本 |
...
├── tests/             # 3,330 用例（pytest 全量，conftest 自动打标记）
