...
**当前规模**：~43,000 行 / 176 个源码文件 / 27 模块 · CLI 67 命令 · 测试 2,970（150 文件，unit 1,580 / integration 245）· 覆盖率 65.82% · 10 个项目级 Skill · Wiki 222 页 · 知识图谱节点 220 / 关系边 1,858（wikilink 1,225 + LLM 633）· 数据源 919 文档 / 6,771 Chunk（text-embedding-v3 / 1,024 维）
