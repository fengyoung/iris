...
**当前规模**：~43,000 行 / 183 个源码文件 / 27 模块 · CLI 68 命令 · 测试 3,313（pytest 全量：unit 2,223 / integration 1,090，含参数化）· 覆盖率 68%（`fail_under` 65）· mypy 基线 193 errors（非阻断）· 10 个项目级 Skill · Wiki 241 页 · 知识图谱节点 220 / 关系边 1,858（wikilink 1,225 + LLM 633）· 数据源 900+ 文档 / 6,771 Chunk（text-embedding-v3 / 1,024 维）
...
| 层 | 位置 | 当前值 | 含义 |
|------|------|:---:|------|
| **产品版本** | `pyproject.toml` | 3.33.1 | 软件发布版本 |
