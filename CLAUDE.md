...
| 层 | 位置 | 当前值 | 含义 |
|------|------|:---:|------|
| **产品版本** | `pyproject.toml` | 3.19.12 | 软件发布版本 |
...
**当前 v3.19.12 (2026-07-21)** — ASR 引擎：LLM 思考模式关闭 + 路由路径 extra_body 修复 + 上下文 A/B 对比模式。v3.19.11 五大方向全面优化：测试 +76 / LLM 统一网关 + 缓存层抽象 + God Class 拆解 + Wiki 模块整理（19 文件，+887 / -64 行，1,829 测试）
