...
~19,200 行 / 99 文件 / 20 模块 · CLI 45 命令 · 单元测试 460（34 文件）· 7 个项目级 Skill · Wiki 91 页 · 数据源 689 文档 / 3,956 Chunk · 向量索引 6,789 条。
...
**当前 v3.11.16 (2026-07-13)** — P0 安全加固：Memory 原子写入、LLMQueryPlanner 实现、API Key 明文提醒、HTTP 客户端去重；测试 397→460（+63）。
