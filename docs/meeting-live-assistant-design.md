...
**日期**：2026-08-12 · **最后校验**：2026-08-26 · **状态**：已实现（v3.23.0 落地 → v3.25.0 本地音频 ASR → v3.26.0 四层能力+说话人区分 → v3.26.1 全量优化+评估修复 → v3.26.2 面板双主题视觉方案 → v3.26.3 面板稳定化+并发加固）· **当前验证版本**：产品 3.28.0 / 协议 3.21
...
- **v3.28.0**（当前验证版本）：会议助理行为不变；共享原子写、项目根解析和质量门禁随全项目工程治理统一。
