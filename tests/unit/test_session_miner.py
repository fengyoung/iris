...
def _sample_session_data():
    return {
        ...
        "topic_threads": {
            ...
            "AI 巡检": {"count": 1, "last_question": "帮我查一下 AI 巡检的目标", "last_mode": "local"},
        },
...
class TestParseMineResponse:
    def test_parse_valid_json(self):
        ...
        payload = {
            ...
            "new_facts": [
                {"fact": "用户是数据智能部负责人", "category": "工作背景"}
            ],
            "confidence": 0.8,
        }
...
class TestPromote:
    def test_promote_recurring_theme_to_notes(self, tmp_path):
        ...
        assert any("AI 巡检" in n for n in prefs.get("notes", []))
    ...
    def test_promote_new_fact_to_notes(self, tmp_path):
        ...
        assert any("用户负责数据智能部" in n for n in notes)
