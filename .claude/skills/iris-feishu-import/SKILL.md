...
向用户展示：
- 📄 文档标题、作者、创建日期
- 📂 将归档到：`SOURCE/XX-分类/`（归档模式分类会自动归入 `YYYYMM/` 或 `YYYY/` 子目录）
...
| 路由目标 | 归档子目录 | 判定条件 |
|---------|:--:|---------|
| `05-会议纪要/` | `YYYYMM/` | 多人（≥3）正式会议（按月归档）|
| `04-讨论思考/` | `YYYYMM/` | 1对1/双人讨论（按月归档）|
| `03-方案报告/` | `YYYY/` | 正式方案或技术结论（按年归档）|
| `08-参考资料/` | `YYYY/` | 外部学习资料（按年归档）|
