...
**v3.18.2** — 全栈代码质量优化：异常处理加固、性能优化、ConfigBundle 统一 Pydantic v2、核心测试 +68。Wiki 192 页 / 知识图谱 192 节点 778 边 / 数据源 703 文档 / 4,096 Chunk / 向量索引 7,035 条。
...
- 1,291 个单元测试（73 个测试文件），覆盖率 54%（仅统计 Iris 自身 LLM 调用）
