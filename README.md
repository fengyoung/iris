...
**v3.18.3** — 60% 覆盖率里程碑：全栈代码质量优化 + CLI 集成测试 + 216 新用例。Wiki 192 页 / 知识图谱 192 节点 778 边 / 数据源 703 文档 / 4,096 Chunk / 向量索引 7,035 条。
...
- 1,439 个单元测试（83 个测试文件），覆盖率 60%（仅统计 Iris 自身 LLM 调用）
